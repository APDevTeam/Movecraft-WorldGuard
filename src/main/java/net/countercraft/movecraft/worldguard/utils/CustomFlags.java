...
public class CustomFlags {
    public static final StateFlag ALLOW_COMBAT_RELEASE = new StateFlag("allow-combat-release", true, RegionGroup.ALL);
    public static final StateFlag ALLOW_CRAFT_SINK = new StateFlag("allow-craft-sink", false, RegionGroup.ALL);
